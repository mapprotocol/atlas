...
func Test_autoGenerateMarkerCfg(t *testing.T) {
	...
	path1 := "~/work/atlasEnv/data/data_ibft1/keystore/UTC--2021-09-08T08-00-15.473724074Z--1c0edab88dbb72b119039c4d14b1663525b3ac15"
	path2 := "~/work/atlasEnv/data/data_ibft1/keystore/UTC--2021-09-08T10-12-17.687481942Z--16fdbcac4d4cc24dca47b9b80f58155a551ca2af"
	path3 := "~/work/atlasEnv/data/data_ibft1/keystore/UTC--2021-09-08T10-16-18.520295371Z--2dc45799000ab08e60b7441c36fcc74060ccbe11"
	path4 := "~/work/atlasEnv/data/data_ibft1/keystore/UTC--2021-09-08T10-16-35.698273293Z--6c5938b49bacde73a8db7c3a7da208846898bff5"
	...
	for i, path := range []string{path1, path2, path3, path4} {
		...
		signature, err := bls.UnsafeSign2(privateKey, common.HexToAddress(account[i]).Bytes())
