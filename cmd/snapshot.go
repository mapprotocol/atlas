...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'atlas dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'atlas dump', but uses the snapshots
