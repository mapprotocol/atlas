...
// be tracer dependent.
func (api *API) traceTx(ctx context.Context, message processor.Message, txctx *Context, vmctx vm.BlockContext, statedb *state.StateDB, config *TraceConfig) (interface{}, error) {
