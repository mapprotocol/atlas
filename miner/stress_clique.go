...
func makeGenesis(faucets []*ecdsa.PrivateKey, sealers []*ecdsa.PrivateKey) *chain.Genesis {
	// Create a Clique network based off of the Rinkeby config
	genesis := chain.DefaultRinkebyGenesisBlock()
	...
	genesis.Alloc = chain.GenesisAlloc{}
	for _, faucet := range faucets {
		genesis.Alloc[crypto.PubkeyToAddress(faucet.PublicKey)] = chain.GenesisAccount{
...
func makeSealer(genesis *chain.Genesis) (*node.Node, *eth.Ethereum, error) {
