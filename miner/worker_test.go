...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db ethdb.Database, n int) *testWorkerBackend {
	var gspec = chain2.Genesis{
		Config: chainConfig,
		Alloc:  chain2.GenesisAlloc{testBankAddress: {Balance: testBankFunds}},
	}
	...
	if n > 0 {
		blocks, _ := chain2.GenerateChain(chainConfig, genesis, engine, db, n, func(i int, gen *chain2.BlockGen) {
	...
	blocks, _ := chain2.GenerateChain(chainConfig, parent, engine, db, 1, func(i int, gen *chain2.BlockGen) {
...
func (b *testWorkerBackend) newRandomUncle() *types.Block {
	...
	blocks, _ := chain2.GenerateChain(b.chain.Config(), parent, b.chain.Engine(), b.db, 1, func(i int, gen *chain2.BlockGen) {
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	chain, _ := chain2.NewBlockChain(db2, nil, b.chain.Config(), engine, vm.Config{}, nil, nil)
	defer chain.Stop()
