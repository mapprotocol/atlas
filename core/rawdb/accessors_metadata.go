...
func ReadChainConfig(db ethdb.KeyValueReader, hash common.Hash) *params2.ChainConfig {
	data, _ := db.Get(configKey(hash))
	if len(data) == 0 {
		return nil
	}
	var config params2.ChainConfig
...
func WriteChainConfig(db ethdb.KeyValueWriter, hash common.Hash, cfg *params2.ChainConfig) {
	if cfg == nil {
		return
	}
