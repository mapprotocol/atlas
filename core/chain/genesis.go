...
func SetupGenesisBlock(db ethdb.Database, genesis *Genesis) (*params2.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil)
}

func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, overrideBerlin *big.Int) (*params2.ChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
		return params2.AllEthashProtocolChanges, common.Hash{}, errGenesisNoConfig
	}
	...
	if genesis == nil && stored != params2.MainnetGenesisHash {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params2.ChainConfig {
	switch {
	case g != nil:
		return g.Config
	...
	default:
		return params2.AllEthashProtocolChanges
	}
}
...
func (g *Genesis) ToBlock(db ethdb.Database) *types.Block {
	...
	for _, member := range relayer {
		var err error
		err = register.InsertAccount2(hh, member.Coinbase, params2.ElectionMinLimitForRegister)
		if err != nil {
...
func (g *Genesis) Commit(db ethdb.Database) (*types.Block, error) {
	...
	config := g.Config
	if config == nil {
		config = params2.AllEthashProtocolChanges
	}
