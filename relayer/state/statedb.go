...
import (
	...
	"github.com/mapprotocol/atlas/relayer"
	"math/big"
	"sort"
	"sync"
)
...
var (
	...
	emptyRoot common.Hash = common.HexToHash("56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421")
)
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/abeychain/go-abey/pull/16485#issuecomment-380438527),
...
func (s *StateDB) Commit(deleteEmptyObjects bool) (root common.Hash, err error) {
	...
	root, err = s.trie.Commit(
		func(_ [][]byte, _ []byte, leaf []byte, parent common.Hash) error {
