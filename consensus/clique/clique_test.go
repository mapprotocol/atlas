...
func TestReimportMirroredState(t *testing.T) {
	...
	genspec := &chain2.Genesis{
		ExtraData: make([]byte, extraVanity+common.AddressLength+extraSeal),
		Alloc: map[common.Address]chain2.GenesisAccount{
	...
	chain, _ := chain2.NewBlockChain(db, nil, params.AllCliqueProtocolChanges, engine, vm.Config{}, nil, nil)
	defer chain.Stop()

	blocks, _ := chain2.GenerateChain(params.AllCliqueProtocolChanges, genesis, engine, db, 3, func(i int, block *chain2.BlockGen) {
